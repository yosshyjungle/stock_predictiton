...
stock_name = st.text_input("例 AAPL, META, SFTBY(大文字・小文字どちらでも可)", "AAPL")
...
try:
    df_stock = pandas_datareader.data.get_data_yahoo(stock_name, '2020-01-05')
    st.header(stock_name + " 2020年1月5日から現在までの価格(USD)")
    st.write(df_stock)
